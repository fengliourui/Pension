...
public class Old_VerifyCode extends AppCompatActivity {

    private static final String TAG = "Old_VerifyCode";
    //viewbinding
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ClickableSpan clickableSpan01 = new ClickableSpan() {
            ...
            public void onClick(@NonNull View view) {
                Intent intent_register = new Intent(Old_VerifyCode.this, register.class);
        ...
        ClickableSpan clickableSpan02 = new ClickableSpan() {
            @Override
            public void onClick(@NonNull View view) {
                Intent intent_password = new Intent(Old_VerifyCode.this, relation_password.class);
                intent_password.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent_password);
                Toast.makeText(Old_VerifyCode.this, "你点击了手机号密码登录", Toast.LENGTH_SHORT).show();
            }
        };
        ...
        spannableString03.setSpan(new ClickableSpan() {
            @Override
            public void onClick(@NonNull View view) {
                Intent intent_manager = new Intent(Old_VerifyCode.this, manager.class);
        ...
        spannableString03.setSpan(new ClickableSpan() {
            @Override
            public void onClick(@NonNull View view) {
                Intent intent_staff = new Intent(Old_VerifyCode.this, staff.class);
        ...
        spannableString03.setSpan(new ClickableSpan() {
            @Override
            public void onClick(@NonNull View view) {
                Intent intent_old = new Intent(Old_VerifyCode.this, MainActivitytht.class);
